/**
 * Rating Generosity — Incremental
 * Formula: 50 + (userMean - globalMean) × 20, clamped 0–100
 */
let globalMeanRating = 3.0; // fallback default
...
export function computeRatingGenerosity(accum) {
  ...
  if (countRating < 5) return { score: null, accum };
